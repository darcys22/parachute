class Main extends Phaser.State {
    ...
    create() {
      ...
      this.direct= url.searchParams.get("d");
      if (this.direct) {
        this.d = this.unpack(this.direct)
        this.remote = true;
      }

      //this.d = this.unpack('555555555555555555555555555555555555599555555555555555555555555555555555555555555555555555556aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa5555555555555555555555555555555555555555556aaaa0123456789abcdfb2aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa8');
      //this.remote = true;
